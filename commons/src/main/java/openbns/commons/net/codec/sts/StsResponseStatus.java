...
public class StsResponseStatus implements Comparable<StsResponseStatus> {
     ...
     */
    public static final StsResponseStatus SWITCHING_PROTOCOLS =
            new StsResponseStatus(101, "Switching Protocols", true);
     ...
     */
    public static final StsResponseStatus NON_AUTHORITATIVE_INFORMATION =
            new StsResponseStatus(203, "Non-Authoritative Information", true);
     ...
     */
    public static final StsResponseStatus PROXY_AUTHENTICATION_REQUIRED =
            new StsResponseStatus(407, "Proxy Authentication Required", true);
     ...
     */
    public static final StsResponseStatus PRECONDITION_FAILED =
            new StsResponseStatus(412, "Precondition Failed", true);

    /**
     * 413 Request Entity Too Large
     */
    public static final StsResponseStatus REQUEST_ENTITY_TOO_LARGE =
            new StsResponseStatus(413, "Request Entity Too Large", true);

    /**
     * 414 Request-URI Too Long
     */
    public static final StsResponseStatus REQUEST_URI_TOO_LONG =
            new StsResponseStatus(414, "Request-URI Too Long", true);

    /**
     * 415 Unsupported Media Type
     */
    public static final StsResponseStatus UNSUPPORTED_MEDIA_TYPE =
            new StsResponseStatus(415, "Unsupported Media Type", true);

    /**
     * 416 Requested Range Not Satisfiable
     */
    public static final StsResponseStatus REQUESTED_RANGE_NOT_SATISFIABLE =
            new StsResponseStatus(416, "Requested Range Not Satisfiable", true);

    /**
     * 417 Expectation Failed
     */
    public static final StsResponseStatus EXPECTATION_FAILED =
            new StsResponseStatus(417, "Expectation Failed", true);

    /**
     * 422 Unprocessable Entity (WebDAV, RFC4918)
     */
    public static final StsResponseStatus UNPROCESSABLE_ENTITY =
            new StsResponseStatus(422, "Unprocessable Entity", true);

    /**
     * 423 Locked (WebDAV, RFC4918)
     */
    public static final StsResponseStatus LOCKED =
            new StsResponseStatus(423, "Locked", true);
     ...
     */
    public static final StsResponseStatus UNORDERED_COLLECTION =
            new StsResponseStatus(425, "Unordered Collection", true);
     ...
     */
    public static final StsResponseStatus PRECONDITION_REQUIRED =
            new StsResponseStatus(428, "Precondition Required", true);
     ...
     */
    public static final StsResponseStatus REQUEST_HEADER_FIELDS_TOO_LARGE =
            new StsResponseStatus(431, "Request Header Fields Too Large", true);

    /**
     * 500 Internal Server Error
     */
    public static final StsResponseStatus INTERNAL_SERVER_ERROR =
            new StsResponseStatus(500, "Internal Server Error", true);
     ...
     */
    public static final StsResponseStatus SERVICE_UNAVAILABLE =
            new StsResponseStatus(503, "Service Unavailable", true);
     ...
     */
    public static final StsResponseStatus HTTP_VERSION_NOT_SUPPORTED =
            new StsResponseStatus(505, "HTTP Version Not Supported", true);

    /**
     * 506 Variant Also Negotiates (RFC2295)
     */
    public static final StsResponseStatus VARIANT_ALSO_NEGOTIATES =
            new StsResponseStatus(506, "Variant Also Negotiates", true);

    /**
     * 507 Insufficient Storage (WebDAV, RFC4918)
     */
    public static final StsResponseStatus INSUFFICIENT_STORAGE =
            new StsResponseStatus(507, "Insufficient Storage", true);
     ...
     */
    public static final StsResponseStatus NETWORK_AUTHENTICATION_REQUIRED =
            new StsResponseStatus(511, "Network Authentication Required", true);
