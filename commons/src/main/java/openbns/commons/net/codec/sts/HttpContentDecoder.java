 ...
 * {@link io.netty.channel.embedded.EmbeddedChannel}, which is created by {@link #newContentDecoder(String)}.
 ...
 * converts {@link io.netty.buffer.ByteBuf}s into HTTP requests.
 */
public abstract class HttpContentDecoder extends MessageToMessageDecoder<HttpObject> {
    ...
    /**
     * Returns a new {@link io.netty.channel.embedded.EmbeddedChannel} that decodes the HTTP message
     * content encoded in the specified <tt>contentEncoding</tt>.
     *
     * @param contentEncoding the value of the {@code "Content-Encoding"} header
     * @return a new {@link io.netty.channel.embedded.EmbeddedChannel} if the specified encoding is supported.
