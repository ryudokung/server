 ...
 *
 * As a workaround to the <a href="sts://goo.gl/I4Nky">HashDOS</a> vulnerability, the decoder
...
public class QueryStringDecoder {
    ...
    public QueryStringDecoder(URI uri, Charset charset, int maxParams) {
        ...
        // Also take care of cut of things like "sts://localhost"
    ...
    private void decodeParams(String s) {
        ...
        for (i = 0; i < s.length(); i++) {
            ...
            if (c == '=' && name == null) {
                ...
                pos = i + 1;
            // sts://www.w3.org/TR/html401/appendix/notes.html#h-B.2.2
            } else if (c == '&' || c == ';') {
                if (name == null && pos != i) {
     ...
     * be {@link io.netty.util.CharsetUtil#UTF_8}.
     * @return The decoded string, or {@code s} if there's nothing to decode.
     * If the string to decode is {@code null}, returns an empty string.
     * @throws IllegalArgumentException if the string contains a malformed
     * escape sequence.
