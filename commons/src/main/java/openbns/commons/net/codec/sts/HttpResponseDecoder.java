...
public class HttpResponseDecoder extends HttpObjectDecoder
{
    ...
    private static final StsResponseStatus UNKNOWN_STATUS = new StsResponseStatus(999, "Unknown");
    ...
    protected HttpMessage createMessage(String[] initialLine) {
        return new DefaultStsResponse(
                StsVersion.valueOf( initialLine[ 0 ] ),
                new StsResponseStatus(Integer.valueOf(initialLine[1]), initialLine[2]), validateHeaders);
    }

    @Override
    protected HttpMessage createInvalidMessage() {
        return new DefaultStsResponse( StsVersion.STS_1_0, UNKNOWN_STATUS, validateHeaders);
    }
