 ...
 * {@link io.netty.channel.embedded.EmbeddedChannel}, which is created by {@link #beginEncode(HttpResponse, String)}.
 ...
 * converts them into {@link io.netty.buffer.ByteBuf}s.
 */
public abstract class HttpContentEncoder extends MessageToMessageCodec<HttpRequest, HttpObject> {
        ...
        switch (state) {
            case AWAIT_HEADERS: {
                ...
                if (isFull) {
                    ...
                    HttpResponse newRes = new DefaultStsResponse(res.getProtocolVersion(), res.getStatus());
                    ...
                    if (!(msg instanceof HttpContent)) {
                        ...
                        // See https://github.com/commons/commons/issues/2006
                        break;
                    }
     ...
     *         target content encoding and a new {@link io.netty.channel.embedded.EmbeddedChannel} that
        ...
        if (encoder != null) {
            ...
            if (encoder.finish()) {
                for (;;) {
                    ...
                    // Release the buffer
                    // https://github.com/commons/commons/issues/1524
                    buf.release();
                }
            }
            encoder = null;
